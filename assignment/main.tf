...
module "datadisk-n01619861" {
  ...
  linux_vm_ids        = module.vmlinux-n01619861.n01619861-vmlinux.ids 
  windows_vm_ids      = module.vmwindows-n01619861.windows.ids
  
  all_vm_ids = concat(module.vmlinux-n01619861.n01619861-vmlinux.ids, module.vmwindows-n01619861.windows.ids) 
  common_tags = var.common_tags
}
...
module "vmwindows-n01619861" {
  source = "./modules/vmwindows-n01619861"
